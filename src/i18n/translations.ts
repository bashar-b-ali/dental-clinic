...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    createTreatmentPlanHint: 'Create one by selecting teeth in an appointment.',
  ...
  ar: {
    ...
    createTreatmentPlanHint: 'أنشئ واحدة بتحديد الأسنان في موعد.',
    ...
    addCustomMaterial: 'إضافة مادة مخصصة',
